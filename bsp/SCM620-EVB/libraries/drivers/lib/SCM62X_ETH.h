...
#ifndef __SCM62X_ETH_H
#define __SCM62X_ETH_H
...
/** 
  * @brief / * MAC  
  */ 
  uint32_t             ETH_CrcStip;                   /*!< Crc stripping enable or not  */
...
/** @defgroup ETH_Pass_Control_Frames 
  * @{
  */ 
#define ETH_PassControlFrames_BlockAll                ((uint32_t)0x00000000)  /*!< MAC filters all control frames from reaching the application */
#define ETH_PassControlFrames_ForwardAllExceptPause   ((uint32_t)0x00000040)  /*!< MAC forwards all control frames except pause frames to application even if they fail the Address Filter  */
#define ETH_PassControlFrames_ForwardAll              ((uint32_t)0x00000080)  /*!< MAC forwards all control frames to application even if they fail the Address Filter */
#define ETH_PassControlFrames_ForwardPassedAddrFilter ((uint32_t)0x000000C0)  /*!< MAC forwards control frames that pass the Address Filter. */ 
#define IS_ETH_CONTROL_FRAMES(PASS) (((PASS) == ETH_PassControlFrames_BlockAll) || \
                                     ((PASS) == ETH_PassControlFrames_ForwardAllExceptPause) || \
...
#define ETH_DMATxDesc_ChecksumIPV4Header         ((uint32_t)0x08000000)   /*!< IPv4 header checksum insertion  */
#define ETH_DMATxDesc_ChecksumTCPUDPICMPSegment  ((uint32_t)0x10000000)   /*!< TCP/UDP/ICMP checksum insertion. Pseudo header checksum is assumed to be present */
#define ETH_DMATxDesc_ChecksumTCPUDPICMPFull     ((uint32_t)0x18000000)   /*!< TCP/UDP/ICMP checksum fully in hardware including pseudo header */
...
/** 
  ...
  */ 
#define IS_ETH_DMATxDESC_BUFFER_SIZE(SIZE) ((SIZE) <= 0x07FF)
...
#define ETH_RxDMABurstLength_8xPBL_8Beat    ((uint32_t)0x01020000)  /*!< maximum number of beats to be transferred in one RxDMA transaction is 4 */
#define ETH_RxDMABurstLength_8xPBL_16Beat   ((uint32_t)0x01040000)  /*!< maximum number of beats to be transferred in one RxDMA transaction is 8 */
#define ETH_RxDMABurstLength_8xPBL_32Beat   ((uint32_t)0x01080000)  /*!< maximum number of beats to be transferred in one RxDMA transaction is 16 */
#define ETH_RxDMABurstLength_8xPBL_64Beat   ((uint32_t)0x01100000)  /*!< maximum number of beats to be transferred in one RxDMA transaction is 32 */
#define ETH_RxDMABurstLength_8xPBL_128Beat  ((uint32_t)0x01200000)  /*!< maximum number of beats to be transferred in one RxDMA transaction is 64 */
#define ETH_RxDMABurstLength_8xPBL_256Beat  ((uint32_t)0x01400000)  /*!< maximum number of beats to be transferred in one RxDMA transaction is 128 */
#define IS_ETH_RXDMA_BURST_LENGTH(LENGTH) (((LENGTH) == ETH_RxDMABurstLength_1Beat) || \
                                           ...
                                           ((LENGTH) == ETH_RxDMABurstLength_8xPBL_8Beat) || \
                                           ((LENGTH) == ETH_RxDMABurstLength_8xPBL_16Beat) || \
                                           ((LENGTH) == ETH_RxDMABurstLength_8xPBL_32Beat) || \
                                           ((LENGTH) == ETH_RxDMABurstLength_8xPBL_64Beat) || \
                                           ((LENGTH) == ETH_RxDMABurstLength_8xPBL_128Beat) || \
                                           ((LENGTH) == ETH_RxDMABurstLength_8xPBL_256Beat))
...
#define ETH_TxDMABurstLength_8xPBL_8Beat    ((uint32_t)0x01000100)  /*!< maximum number of beats to be transferred in one TxDMA (or both) transaction is 4 */
#define ETH_TxDMABurstLength_8xPBL_16Beat    ((uint32_t)0x01000200)  /*!< maximum number of beats to be transferred in one TxDMA (or both) transaction is 8 */
#define ETH_TxDMABurstLength_8xPBL_32Beat   ((uint32_t)0x01000400)  /*!< maximum number of beats to be transferred in one TxDMA (or both) transaction is 16 */
#define ETH_TxDMABurstLength_8xPBL_64Beat   ((uint32_t)0x01000800)  /*!< maximum number of beats to be transferred in one TxDMA (or both) transaction is 32 */
#define ETH_TxDMABurstLength_8xPBL_128Beat   ((uint32_t)0x01001000)  /*!< maximum number of beats to be transferred in one TxDMA (or both) transaction is 64 */
#define ETH_TxDMABurstLength_8xPBL_256Beat  ((uint32_t)0x01002000)  /*!< maximum number of beats to be transferred in one TxDMA (or both) transaction is 128 */
#define IS_ETH_TXDMA_BURST_LENGTH(LENGTH) (((LENGTH) == ETH_TxDMABurstLength_1Beat) || \
                                           ...
                                           ((LENGTH) == ETH_TxDMABurstLength_8xPBL_8Beat) || \
                                           ((LENGTH) == ETH_TxDMABurstLength_8xPBL_16Beat) || \
                                           ((LENGTH) == ETH_TxDMABurstLength_8xPBL_32Beat) || \
                                           ((LENGTH) == ETH_TxDMABurstLength_8xPBL_64Beat) || \
                                           ((LENGTH) == ETH_TxDMABurstLength_8xPBL_128Beat) || \
                                           ((LENGTH) == ETH_TxDMABurstLength_8xPBL_256Beat))
/** 
...
#define ETH_DMA_FLAG_RxDmaWriteDataError       ((uint32_t)0x00000000)  /*!< Error during Rx DMA write data transfer */
#define ETH_DMA_FLAG_TxDmaReadDataError        ((uint32_t)0x01800000)  /*!< Error during Tx DMA read data transfer */
#define ETH_DMA_FLAG_RxDmaDescriptorWriteError ((uint32_t)0x02000000)  /*!< Error during Rx DMA Descriptor write access*/
#define ETH_DMA_FLAG_TxDmaDescriptorWriteError ((uint32_t)0x02800000)  /*!< Error during Tx DMA Descriptor write access */
#define ETH_DMA_FLAG_RxDmaDescriptorReadError  ((uint32_t)0x03000000)  /*!< Error during Rx DMA Descriptor Read access */
#define ETH_DMA_FLAG_TxDmaDescriptorReadError  ((uint32_t)0x03800000)  /*!< Error during Tx DMA Descriptor Read access*/
...
#define IS_ETH_DMA_GET_FLAG(FLAG) (((FLAG) == ETH_DMA_FLAG_TST) || ((FLAG) == ETH_DMA_FLAG_PMT) || \
                                   ((FLAG) == ETH_DMA_FLAG_MMC) || ((FLAG) == ETH_DMA_FLAG_RxDmaWriteDataError) || \
                                   ((FLAG) == ETH_DMA_FLAG_TxDmaDescriptorWriteError) || ((FLAG) == ETH_DMA_FLAG_RxDmaDescriptorReadError) || \
                                   ((FLAG) == ETH_DMA_FLAG_TxDmaDescriptorReadError)  || \
...
uint32_t ETH_Init(ETH_TypeDef *ETH, ETH_InitTypeDef* ETH_InitStruct, u16 PHYAddress);
...
uint32_t ETH_HandleTxPkt(ETH_TypeDef *ETH, u8 *ppkt, u16 FrameLength);
uint32_t ETH_HandleRxPkt(ETH_TypeDef *ETH, u8 *ppkt);
uint32_t ETH_GetRxPktSize(void);
void ETH_DropRxPkt(ETH_TypeDef *ETH);

/** 
  * @brief  PHY  
  */ 
u16 ETH_ReadPHYRegister(ETH_TypeDef *ETH, u16 PHYAddress, u16 PHYReg);
uint32_t ETH_WritePHYRegister(ETH_TypeDef *ETH, u16 PHYAddress, u16 PHYReg, u16 PHYValue);
uint32_t ETH_PHYLoopBackCmd(ETH_TypeDef *ETH, u16 PHYAddress, FunctionalState NewState);
...
FlagStatus ETH_GetFlowControlBusyStatus(ETH_TypeDef *ETH);
void ETH_InitiatePauseControlFrame(ETH_TypeDef *ETH);  
void ETH_BackPressureActivationCmd(ETH_TypeDef *ETH, FunctionalState NewState); 
FlagStatus ETH_GetMACFlagStatus(ETH_TypeDef *ETH, uint32_t ETH_MAC_FLAG);  
ITStatus ETH_GetMACITStatus(ETH_TypeDef *ETH, uint32_t ETH_MAC_IT);
void ETH_MACITConfig(ETH_TypeDef *ETH, uint32_t ETH_MAC_IT, FunctionalState NewState);
void ETH_MACAddressConfig(ETH_TypeDef *ETH, uint32_t MacAddr, u8 *Addr);
void ETH_GetMACAddress(ETH_TypeDef *ETH, uint32_t MacAddr, u8 *Addr);
void ETH_MACAddressPerfectFilterCmd(ETH_TypeDef *ETH, uint32_t MacAddr, FunctionalState NewState);
void ETH_MACAddressFilterConfig(ETH_TypeDef *ETH, uint32_t MacAddr, uint32_t Filter);
void ETH_MACAddressMaskBytesFilterConfig(ETH_TypeDef *ETH, uint32_t MacAddr, uint32_t MaskByte);

/** 
  * @brief  DMA Tx/Rx descriptors  
  */ 
void ETH_DMATxDescChainInit(ETH_TypeDef *ETH, ETH_DMADESCTypeDef *DMATxDescTab, u8 *TxBuff, uint32_t TxBuffCount);
void ETH_DMATxDescRingInit(ETH_TypeDef *ETH, ETH_DMADESCTypeDef *DMATxDescTab, u8 *TxBuff1, u8 *TxBuff2, uint32_t TxBuffCount);
...
void ETH_DMARxDescChainInit(ETH_TypeDef *ETH, ETH_DMADESCTypeDef *DMARxDescTab, u8 *RxBuff, uint32_t RxBuffCount);
void ETH_DMARxDescRingInit(ETH_TypeDef *ETH, ETH_DMADESCTypeDef *DMARxDescTab, u8 *RxBuff1, u8 *RxBuff2, uint32_t RxBuffCount);
...
/** 
  * @brief  DMA
  */ 
FlagStatus ETH_GetDMAFlagStatus(ETH_TypeDef *ETH, uint32_t ETH_DMA_FLAG);
void ETH_DMAClearFlag(ETH_TypeDef *ETH, uint32_t ETH_DMA_FLAG);
...
uint32_t ETH_GetTransmitProcessState(ETH_TypeDef *ETH);
uint32_t ETH_GetReceiveProcessState(ETH_TypeDef *ETH);
void ETH_FlushTransmitFIFO(ETH_TypeDef *ETH);
FlagStatus ETH_GetFlushTransmitFIFOStatus(ETH_TypeDef *ETH);
...
FlagStatus ETH_GetDMAOverflowStatus(ETH_TypeDef *ETH,uint32_t ETH_DMA_Overflow);
uint32_t ETH_GetRxOverflowMissedFrameCounter(ETH_TypeDef *ETH);
uint32_t ETH_GetBufferUnavailableMissedFrameCounter(ETH_TypeDef *ETH);
uint32_t ETH_GetCurrentTxDescStartAddress(ETH_TypeDef *ETH);
uint32_t ETH_GetCurrentRxDescStartAddress(ETH_TypeDef *ETH);
uint32_t ETH_GetCurrentTxBufferAddress(ETH_TypeDef *ETH);
uint32_t ETH_GetCurrentRxBufferAddress(ETH_TypeDef *ETH);
void ETH_ResumeDMATransmission(ETH_TypeDef *ETH);
void ETH_ResumeDMAReception(ETH_TypeDef *ETH);

/** 
  * @brief  PMT  
  */ 
void ETH_ResetWakeUpFrameFilterRegisterPointer(ETH_TypeDef *ETH);
void ETH_SetWakeUpFrameFilterRegister(ETH_TypeDef *ETH, uint32_t *Buffer);
void ETH_GlobalUnicastWakeUpCmd(ETH_TypeDef *ETH, FunctionalState NewState);
FlagStatus ETH_GetPMTFlagStatus(ETH_TypeDef *ETH, uint32_t ETH_PMT_FLAG);
void ETH_WakeUpFrameDetectionCmd(ETH_TypeDef *ETH, FunctionalState NewState);
void ETH_MagicPacketDetectionCmd(ETH_TypeDef *ETH, FunctionalState NewState);
void ETH_PowerDownCmd(ETH_TypeDef *ETH, FunctionalState NewState);

/** 
  * @brief  MMC  
  */ 
void ETH_MMCCounterFreezeCmd(ETH_TypeDef *ETH, FunctionalState NewState);
void ETH_MMCResetOnReadCmd(ETH_TypeDef *ETH, FunctionalState NewState);
void ETH_MMCCounterRolloverCmd(ETH_TypeDef *ETH, FunctionalState NewState);
void ETH_MMCCountersReset(ETH_TypeDef *ETH);
void ETH_MMCITConfig(ETH_TypeDef *ETH,uint32_t ETH_MMC_IT, FunctionalState NewState);
ITStatus ETH_GetMMCITStatus(ETH_TypeDef *ETH, uint32_t ETH_MMC_IT);
uint32_t ETH_GetMMCRegister(ETH_TypeDef *ETH, uint32_t ETH_MMCReg);

/** 
  * @brief  PTP  
  */ 
uint32_t ETH_HandlePTPTxPkt(ETH_TypeDef *ETH, u8 *ppkt, u16 FrameLength, uint32_t *PTPTxTab);
uint32_t ETH_HandlePTPRxPkt(ETH_TypeDef *ETH, u8 *ppkt, uint32_t *PTPRxTab);
void ETH_DMAPTPTxDescChainInit(ETH_TypeDef *ETH, ETH_DMADESCTypeDef *DMATxDescTab, ETH_DMADESCTypeDef *DMAPTPTxDescTab, u8* TxBuff, uint32_t TxBuffCount);
void ETH_DMAPTPRxDescChainInit(ETH_TypeDef *ETH, ETH_DMADESCTypeDef *DMARxDescTab, ETH_DMADESCTypeDef *DMAPTPRxDescTab, u8 *RxBuff, uint32_t RxBuffCount);
void ETH_EnablePTPTimeStampAddend(ETH_TypeDef *ETH);
void ETH_EnablePTPTimeStampInterruptTrigger(ETH_TypeDef *ETH);
void ETH_EnablePTPTimeStampUpdate(ETH_TypeDef *ETH);
void ETH_InitializePTPTimeStamp(ETH_TypeDef *ETH);
void ETH_PTPUpdateMethodConfig(ETH_TypeDef *ETH,uint32_t UpdateMethod);
void ETH_PTPTimeStampCmd(ETH_TypeDef *ETH,FunctionalState NewState);
FlagStatus ETH_GetPTPFlagStatus(ETH_TypeDef *ETH,uint32_t ETH_PTP_FLAG);
void ETH_SetPTPSubSecondIncrement(ETH_TypeDef *ETH,uint32_t SubSecondValue);
void ETH_SetPTPTimeStampUpdate(ETH_TypeDef *ETH,uint32_t Sign, uint32_t SecondValue, uint32_t SubSecondValue);
void ETH_SetPTPTimeStampAddend(ETH_TypeDef *ETH,uint32_t Value);
void ETH_SetPTPTargetTime(ETH_TypeDef *ETH, uint32_t HighValue, uint32_t LowValue);
uint32_t ETH_GetPTPRegister(ETH_TypeDef *ETH, uint32_t ETH_PTPReg);
