...
#ifndef __SCM62X_REGBIT_H__
#define __SCM62X_REGBIT_H__ 
...
---------------------------------------*/
/*SYSCLK_CTRL*/
#define SYSCLK_CTRL_NFCCLK_DIV4_SELB          25
#define SYSCLK_CTRL_NFCCLK_DIV4_SEL          (1 << 25)
#define SYSCLK_CTRL_NFCCLK_DIV4_SEL_HCLKDIV4          (0 << 25)
#define SYSCLK_CTRL_NFCCLK_DIV4_SEL_HCLKDIV8          (1 << 25)
...
#define SYSCLK_CTRL_ANA_CLK_MUX_XHOSC_DIV16     (0x2 << 21)
#define SYSCLK_CTRL_ANA_CLK_MUX_HOSC_DIV64     (0x3 << 21)
#define SYSCLK_CTRL_ANA_CLK_MUX_PLL_DIV256     (0x4 << 21)
...
#define SYSCLK_CTRL_XLOSC_ENB           1 //SGCC_RTC_P->RTC_CLKRST_cfg 
#define SYSCLK_CTRL_XLOSC_EN           (1 << 1)
...
/*HCLK_EN*/
#define HCLK_EN_XSRAMB             12
#define HCLK_EN_XSRAM              (1 << 12)

#define HCLK_EN_NFCB             11
#define HCLK_EN_NFC              (1 << 11)

#define HCLK_EN_AESB             10
#define HCLK_EN_AES              (1 << 10)

#define HCLK_EN_SM4B             9
#define HCLK_EN_SM4              (1 << 9)
...
/*PCLK0_EN*/
#define PCLK0_EN_CAN1B             20
#define PCLK0_EN_CAN1             (1 << 20)

#define PCLK0_EN_CAN0B             19
#define PCLK0_EN_CAN0             (1 << 19)

#define PCLK0_EN_7816B             18
#define PCLK0_EN_7816             (1 << 18)

#define PCLK0_EN_PWMAB             17
#define PCLK0_EN_PWMA             (1 << 17)
...
/*PCLK1_EN*/
#define PCLK1_EN_CAN2B             22
#define PCLK1_EN_CAN2             (1 << 22)

#define PCLK1_EN_ADC2_CLKB           21
#define PCLK1_EN_ADC2_CLK           (1 << 21)

#define PCLK1_EN_ANA2_W1B           20
#define PCLK1_EN_ANA2_W1           (1 << 20)

#define PCLK1_EN_ANA2B           19
#define PCLK1_EN_ANA2           (1 << 19)

#define PCLK1_EN_ADC1_CLKB           18
#define PCLK1_EN_ADC1_CLK           (1 << 18)

#define PCLK1_EN_ANA1_W1B           17
#define PCLK1_EN_ANA1_W1           (1 << 17)

#define PCLK1_EN_ANA1B           16
#define PCLK1_EN_ANA1           (1 << 16)

#define PCLK1_EN_ADC0_CLKB           15
#define PCLK1_EN_ADC0_CLK           (1 << 15)

#define PCLK1_EN_ANA0_W1B           14
#define PCLK1_EN_ANA0_W1           (1 << 14)

#define PCLK1_EN_ANA0B           13
#define PCLK1_EN_ANA0           (1 << 13)

#define PCLK1_EN_PWMBB           12
#define PCLK1_EN_PWMB           (1 << 12)
...
---------------------------------------*/
/*SYS_CTRL*/
#define SYS_CTRL_TRNG_SAMP_ENB    7
#define SYS_CTRL_TRNG_SAMP_EN     (1 << 7)
...
#define UART_CTRL_Tx_fifo_flushB        8
#define UART_CTRL_Tx_fifo_flush        ((UINT32)1 << 8)
#define UART_CTRL_Rx_fifo_flushB        9
#define UART_CTRL_Rx_fifo_flush        ((UINT32)1 << 9)

#define UART_CTRL_CTSENB            10
#define UART_CTRL_CTSEN            ((UINT32)1 << 10)
#define UART_CTRL_CTSDIS           ((UINT32)0 << 10)

#define UART_CTRL_RTSENB            11
#define UART_CTRL_RTSEN            ((UINT32)1 << 11)
#define UART_CTRL_RTSDIS           ((UINT32)0 << 11)

#define UART_CTRL_rts_recover_intENB            28
#define UART_CTRL_rts_recover_intEN            ((UINT32)1 << 28)
#define UART_CTRL_rts_recover_intDIS           ((UINT32)0 << 28)

#define UART_CTRL_rts_stop_intENB            29
#define UART_CTRL_rts_stop_intEN            ((UINT32)1 << 29)
#define UART_CTRL_rts_stop_intDIS           ((UINT32)0 << 29)

#define UART_CTRL_cts_recover_intENB            30
#define UART_CTRL_cts_recover_intEN            ((UINT32)1 << 30)
#define UART_CTRL_cts_recover_intDIS           ((UINT32)0 << 30)

#define UART_CTRL_cts_stop_intENB            31
#define UART_CTRL_cts_stop_intEN            ((UINT32)1 << 31)
#define UART_CTRL_cts_stop_intDIS           ((UINT32)0 << 31)
...
#define UART_INTSTATUS_stop_errorB          3
#define UART_INTSTATUS_stop_error          ((UINT32)1 << 3)

#define UART_INTSTATUS_parity_errorB          4
#define UART_INTSTATUS_parity_error          ((UINT32)1 << 4)

#define UART_INTSTATUS_rts_recover_int_stB          5
#define UART_INTSTATUS_rts_recover_int_st         ((UINT32)1 << 5)

#define UART_INTSTATUS_rts_stop_int_stB          6
#define UART_INTSTATUS_rts_stop_int_st         ((UINT32)1 << 6)

#define UART_INTSTATUS_cts_recover_int_stB          7
#define UART_INTSTATUS_cts_recover_int_st         ((UINT32)1 << 7)

#define UART_INTSTATUS_cts_stop_int_stB          8
#define UART_INTSTATUS_cts_stop_int_st         ((UINT32)1 << 8)
...
#define DMA_TRIG_ADC000_RDY      39
#define DMA_TRIG_ADC001_RDY      40
#define DMA_TRIG_ADC002_RDY      41
#define DMA_TRIG_ADC003_RDY      42
#define DMA_TRIG_ADC004_RDY      43
#define DMA_TRIG_ADC005_RDY      44
#define DMA_TRIG_ADC006_RDY      45
#define DMA_TRIG_ADC007_RDY      46
#define DMA_TRIG_ADC008_RDY      47
#define DMA_TRIG_ADC009_RDY      48
#define DMA_TRIG_ADC010_RDY      49
#define DMA_TRIG_ADC011_RDY      50
#define DMA_TRIG_ADC100_RDY      51
#define DMA_TRIG_ADC101_RDY      52
#define DMA_TRIG_ADC102_RDY      53
#define DMA_TRIG_ADC103_RDY      54
#define DMA_TRIG_ADC104_RDY      55
#define DMA_TRIG_ADC105_RDY      56
#define DMA_TRIG_ADC106_RDY      57
#define DMA_TRIG_ADC107_RDY      58
#define DMA_TRIG_ADC108_RDY      59
#define DMA_TRIG_ADC109_RDY      60
#define DMA_TRIG_ADC110_RDY      61
#define DMA_TRIG_ADC111_RDY      62
#define DMA_TRIG_ADC200_RDY      51
#define DMA_TRIG_ADC201_RDY      52
#define DMA_TRIG_ADC202_RDY      53
#define DMA_TRIG_ADC203_RDY      54
#define DMA_TRIG_ADC204_RDY      55
#define DMA_TRIG_ADC205_RDY      56
#define DMA_TRIG_ADC206_RDY      57
#define DMA_TRIG_ADC207_RDY      58
#define DMA_TRIG_ADC208_RDY      59
#define DMA_TRIG_ADC209_RDY      60
#define DMA_TRIG_ADC210_RDY      61
#define DMA_TRIG_ADC211_RDY      62

#define DMA_TRIG_NONE      63
...
#define ADC_CON1_ADC_TRIGGER_SELBF   1
#define ADC_CON1_ADC_TRIGGER_SEL     (3 << 1)
#define ADC_CON1_ADC_TRIGGER_SEL_TIMERB1  (0 << 1)
#define ADC_CON1_ADC_TRIGGER_SEL_TIMERC1  (1 << 1)
#define ADC_CON1_ADC_TRIGGER_SEL_TIMERD1  (2 << 1)
...
#define ADC_CON3_CHNCOMBINED             ((UINT32)1 << 16)
#define ADC_CON3_CHNCOMBINED_1           ((UINT32)1 << 16)
#define ADC_CON3_CHNCOMBINED_0           ((UINT32)0 << 16)
...
#define BG_REG_TRIMBF           0
#define BG_REG_TRIM             0xF
#define BG_REG_TRIM_520mv       0x0
#define BG_REG_TRIM_530mv       0x1
#define BG_REG_TRIM_540mv       0x2
#define BG_REG_TRIM_550mv       0x3
#define BG_REG_TRIM_560mv       0x4
#define BG_REG_TRIM_570mv       0x5
#define BG_REG_TRIM_580mv       0x6
#define BG_REG_TRIM_590mv       0x7
#define BG_REG_TRIM_600mv       0x8
#define BG_REG_TRIM_610mv       0x9
#define BG_REG_TRIM_620mv       0xA
#define BG_REG_TRIM_630mv       0xB
#define BG_REG_TRIM_640mv       0xC
#define BG_REG_TRIM_650mv       0xD
#define BG_REG_TRIM_660mv       0xE
#define BG_REG_TRIM_670mv       0xF
...
#define VR12_REG_TRIMBF        0x0
#define VR12_REG_TRIM          0xF
#define VR12_REG_TRIM_1040mv         0x0
#define VR12_REG_TRIM_1060mv         0x1
#define VR12_REG_TRIM_1080mv         0x2
#define VR12_REG_TRIM_1100mv         0x3
#define VR12_REG_TRIM_1120mv         0x4
#define VR12_REG_TRIM_1140mv         0x5
#define VR12_REG_TRIM_1160mv         0x6
#define VR12_REG_TRIM_1180mv         0x7
#define VR12_REG_TRIM_1200mv         0x8
#define VR12_REG_TRIM_1220mv         0x9
#define VR12_REG_TRIM_1240mv         0xA
#define VR12_REG_TRIM_1260mv         0xB
#define VR12_REG_TRIM_1280mv         0xC
#define VR12_REG_TRIM_1300mv         0xD
#define VR12_REG_TRIM_1320mv         0xE
#define VR12_REG_TRIM_1340mv         0xF
...
//VD33
#define VD33_REG_TRIMBF                  0
#define VD33_REG_TRIM                    0xF
#define VD33_REG_TRIM_2P62v              0x0
#define VD33_REG_TRIM_2P655v             0x1
#define VD33_REG_TRIM_2P69v              0x2
#define VD33_REG_TRIM_2P725v             0x3
#define VD33_REG_TRIM_2P76v              0x4
#define VD33_REG_TRIM_2P795v             0x5
#define VD33_REG_TRIM_2P83v              0x6
#define VD33_REG_TRIM_2P865v             0x7
#define VD33_REG_TRIM_2P9v               0x8
#define VD33_REG_TRIM_2P935v             0x9
#define VD33_REG_TRIM_2P97v              0xA
#define VD33_REG_TRIM_3P005v             0xB
#define VD33_REG_TRIM_3P04v              0xC
#define VD33_REG_TRIM_3P075v             0xD
#define VD33_REG_TRIM_3P11v               0xE
#define VD33_REG_TRIM_3P145v             0xF

//LOSC_REG
#define LOSC_REG_TRIMBF                  0x0
#define LOSC_REG_TRIM                    (0xF)
#define LOSC_REG_TRIM_0              0x0
#define LOSC_REG_TRIM_1              0x1 
#define LOSC_REG_TRIM_2              0x2
#define LOSC_REG_TRIM_3              0x3 
#define LOSC_REG_TRIM_4              0x4
#define LOSC_REG_TRIM_5              0x5 
#define LOSC_REG_TRIM_6              0x6
#define LOSC_REG_TRIM_7              0x7 
#define LOSC_REG_TRIM_8              0x8
#define LOSC_REG_TRIM_9              0x9 
#define LOSC_REG_TRIM_10              0xA
#define LOSC_REG_TRIM_11              0xB 
#define LOSC_REG_TRIM_12              0xC
#define LOSC_REG_TRIM_13              0xD 
#define LOSC_REG_TRIM_14              0xE
#define LOSC_REG_TRIM_15              0xF 
...
//XLOSC_REG
#define XLOSC_REG_DRVBF                    0x1
#define XLOSC_REG_DRV                    (0x7 << 1)
#define XLOSC_REG_DRV_0                  (0x0 << 1)
#define XLOSC_REG_DRV_1                  (0x1 << 1)
#define XLOSC_REG_DRV_2                  (0x2 << 1)
#define XLOSC_REG_DRV_3                  (0x3 << 1)
#define XLOSC_REG_DRV_4                  (0x4 << 1)
#define XLOSC_REG_DRV_5                  (0x5 << 1)
#define XLOSC_REG_DRV_6                  (0x6 << 1)
#define XLOSC_REG_DRV_7                  (0x7 << 1)

//XHOSC_REG
#define XHOSC_REG_GMBF                    0x2
#define XHOSC_REG_GM                      (0x3 << 2)
#define XHOSC_REG_GM_(i)                  ((i) << 2)

#define XHOSC_REG_DRVBF                    0x4
#define XHOSC_REG_DRV                      (0x7 << 4)
#define XHOSC_REG_DRV_900UA                (0 << 4)
#define XHOSC_REG_DRV_1800UA               (1 << 4)

#define XHOSC_REG_ST_CTLB                0x7
#define XHOSC_REG_ST_CTL_NORMAL          (0 << 0x7)
#define XHOSC_REG_ST_CTL_INCREASE        (1 << 0x7)

//ANATEST_REG
#define ANATEST_REG_SELBF                0x0
#define ANATEST_REG_SEL                  0xF
#define ANATEST_REG_SEL_AN(i)            (i)

#define ANATEST_REG_ENVDB                0x4
#define ANATEST_REG_ENVD                 (1 << 0x4)

//TRNG_CFG
#define TRNG_CFG_FOPTB                    0x4
#define TRNG_CFG_FOPT                    (1 << 0x4)
#define TRNG_CFG_FOPT_0                  (0 << 0x4)
#define TRNG_CFG_FOPT_1                  (1 << 0x4)

#define TRNG_CFG_SOPTBF                    0x2
#define TRNG_CFG_SOPT                    (3 << 0x2)
#define TRNG_CFG_SOPT_0                  (0 << 0x2)
#define TRNG_CFG_SOPT_1                  (1 << 0x2)
#define TRNG_CFG_SOPT_2                  (2 << 0x2)
#define TRNG_CFG_SOPT_3                  (3 << 0x2)

#define TRNG_CFG_SELB                    0x1
#define TRNG_CFG_SEL                    (1 << 0x1)
#define TRNG_CFG_SEL_0                  (0 << 0x1)
#define TRNG_CFG_SEL_1                  (1 << 0x1)

#define TRNG_CFG_EN_TRNGSAMPB             0x0
#define TRNG_CFG_EN_TRNGSAMP              (1 << 0x0)
...
#define ETH_MACCR_CST             ((uint32_t)0x02000000)  /* CRC stripping  for type frames*/
#define ETH_MACCR_CST_ENABLE      ((uint32_t)0x02000000)  /* CRC stripping  for type frames*/
#define ETH_MACCR_CST_DISABLE     ((uint32_t)0x00000000)  /* CRC stripping  for type frames*/
...
---------------------------------------*/
//SM4_CR
#define SM4_CR_CSB                    0x3
#define SM4_CR_CS                     (1 << 3)

#define SM4_CR_AEB                    0x2
#define SM4_CR_AE                    (1 << 2)

#define SM4_CR_IV_RSTB                    0x1
#define SM4_CR_IV_RST                     (1 << 1)

#define SM4_CR_KEY_RSTB                    0x0
#define SM4_CR_KEY_RST                     (1 << 0)

//SM4_MR
#define SM4_MR_DPAWB                    0x5
#define SM4_MR_DPAW                     (1 << 5)

#define SM4_MR_DPAWRBF                   0x3
#define SM4_MR_DPAWR                     (0x3 << 3)
#define SM4_MR_DPAWR_25_PER          (0x1 << 3)
#define SM4_MR_DPAWR_50_PER          (0x0 << 3)
#define SM4_MR_DPAWR_75_PER          (0x3 << 3)

#define SM4_MR_WM_SELB                   0x1
#define SM4_MR_WM_SEL                     (0x1 << 1)
#define SM4_MR_WM_SEL_ECB                 (0x0 << 1)
#define SM4_MR_WM_SEL_CBC                 (0x1 << 1)

#define SM4_MR_ENC_SELB                   0x0
#define SM4_MR_ENC_SEL                     (0x1 << 0)
#define SM4_MR_ENC_SEL_ENCRYPT             (0x1 << 0)
#define SM4_MR_ENC_SEL_DECRYPT             (0x0 << 0)

//SM4_IER
#define SM4_IER_DONEB                   0x0
#define SM4_IER_DONE                   (1 << 0x0)

//SM4_SR
#define SM4_SR_DONEB                   0x0
#define SM4_SR_DONE                   (1 << 0x0)

/* -------------------------------------
                 AES
---------------------------------------*/
//AES_CNTRL
#define AES_CNTRL_STARTB                    0x0
#define AES_CNTRL_START                     (1 << 0)

#define AES_CNTRL_FUNC_SELBF                 0x1
#define AES_CNTRL_FUNC_SEL                   (3 << 1)
#define AES_CNTRL_FUNC_SEL_ENC               (0 << 1)
#define AES_CNTRL_FUNC_SEL_STDEC             (1 << 1)
#define AES_CNTRL_FUNC_SEL_KEYEXP            (2 << 1)
#define AES_CNTRL_FUNC_SEL_SIMDEC            (3 << 1)

#define AES_CNTRL_KEY_SELBF                 0x3
#define AES_CNTRL_KEY_SEL                   (3 << 3)
#define AES_CNTRL_KEY_SEL_128B              (0 << 3)
#define AES_CNTRL_KEY_SEL_192B              (1 << 3)
#define AES_CNTRL_KEY_SEL_256B              (2 << 3)

#define AES_CNTRL_RAND_ENB              5
#define AES_CNTRL_RAND_EN              (1 << 5)

#define AES_CNTRL_STEP_ENB              6
#define AES_CNTRL_STEP_EN              (1 << 6)
